var cardData = [
	...
	['あくどい','1</p<p class="meaning cardback">>. gaudy, showy, excessive, 2. vicious'],
	['悪日','あくび','unlucky day'],
	...
	['きっぱり','clearly</p<p class="meaning cardback">>, plainly, distinctly'],
	...
	['ずれる','to</p> <p class="meaning cardback">slide, to slip off'],
	...
	['調理','ちょうり','cooking'],
	['調和','ちょうわ','harmony'],
	['ちょくちょく','often</p<p class="meaning cardback">>, frequently, now and then, occasionally'],
	...
	['ふんだん','plentiful</p<p class="meaning cardback">>, abundant, lavish'],
